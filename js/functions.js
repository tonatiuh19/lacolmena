...
$('#banner-headings').animate({
    right: '-500'
       ...
       if($.browser.version == "8.0" || $.browser.version == "7.0") {
           $('.banner-slide-images li').eq(index).css("display","none");
           ...
           $('.banner-slide-images li').eq(index).css("display","block");
...
$('.arrowLeft').click(function(){
  ...
  $('li.dropdown').hover(function () {
      ...
      if(navAnimation) {
          navAnimation = false;
        $(this).children("ul").stop().slideUp(200, function(){navAnimation = true;});
        }
  });
    ...
    $(".banner-cube-last").hover(function(){
        ...
        $(".banner-cube-first").hover(function(){
            $(".banner-cube-first .imageHover").show();
        }, function() {
            $(".banner-cube-first .imageHover").hide();
        });

        $(".banner-cube-middle").hover(function(){
            $(".banner-cube-middle .imageHover").show();
        }, function() {
            $(".banner-cube-middle .imageHover").hide();
        });

        $(".banner-cube-last").hover(function(){
            $(".banner-cube-last .imageHover").show();
        }, function() {
            $(".banner-cube-last .imageHover").hide();
        });
    }
    if($.browser.msie){
