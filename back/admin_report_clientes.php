...
<body class="TextFont">
    ...
    <tr><td><b><font color="#006699">SISTEMA DE ADMINISTRADOR > MENÚ > REPORTE DE CLIENTES</font></b></td></tr>
    <tr height="10"><td colspan="2"></td></tr>
    <tr><td>ADMINISTRADOR: <?php echo $_SESSION['adusername']?></td></tr>
    <tr height="20"><td colspan="2"></td></tr>
    <tr><td>
            <?php
			$query  = "SELECT * FROM clientes"; $result = mysql_query($query);
			$count=mysql_num_rows($result);
			if($count>=1){
			echo "<table width='100%' border='1'>";
			echo "<tr><td><b>ID</b></td><td><b>NOMBRE</b></td><td><b>APELLIDO</b></td>";			
			echo "<td><b>DIRECCIÓN</b></td><td><b>TELÉFONO</b></td></tr>";			
			while ($row = @mysql_fetch_array($result, MYSQL_ASSOC)) {
				echo "<tr><td>".@$row['id_cliente']."</td><td>".@$row['nombre']."</td><td>".@$row['apellido']."</td>".
				"<td>".@$row['direccion']."</td><td width='150'>".@$row['telefono']."</td></tr>";
			}
			echo "</table><br />";
			} else {
